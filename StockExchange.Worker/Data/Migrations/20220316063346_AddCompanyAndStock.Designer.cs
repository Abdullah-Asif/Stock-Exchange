...
namespace StockExchange.Worker.Data.Migrations
{
    ...
    [Migration("20220316063346_AddCompanyAndStock")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockExchange.Scraping.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StockExchange.Scraping.Entities.StockPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StockExchange.Scraping.Entities.StockPrice", b =>
                {
                    b.HasOne("StockExchange.Scraping.Entities.Company", "Company")
